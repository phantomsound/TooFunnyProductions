...
export default function AdminSettingsGeneral(): JSX.Element {
  ...
  const footerLinks = safe.footer_links;
    ...
    <div className="space-y-10">
      ...
      <section>
        ...
        <div className="flex items-center gap-2 mb-3">
          <input
            id="maint_enabled"
            type="checkbox"
            checked={safe.maintenance_enabled}
        ...
        <label className="block mb-3">
          ...
          <input
            className="w-full border border-gray-300 rounded px-3 py-2 text-black"
            value={safe.maintenance_message}
        ...
        <div className="flex items-center gap-2 mb-3">
          <input
            id="maint_schedule"
            type="checkbox"
            checked={safe.maintenance_schedule_enabled}
        ...
        <div className="grid md:grid-cols-3 gap-3">
          <label className="block">
            ...
            <input
              className="w-full border border-gray-300 rounded px-3 py-2 text-black"
              placeholder="02:00"
              value={safe.maintenance_daily_start}
          ...
          <label className="block">
            ...
            <input
              className="w-full border border-gray-300 rounded px-3 py-2 text-black"
              placeholder="02:30"
              value={safe.maintenance_daily_end}
          ...
          <label className="block">
            ...
            <input
              ...
              value={safe.maintenance_timezone}
      ...
      <section>
        ...
        <select
          ...
          value={safe.session_timeout_minutes}
