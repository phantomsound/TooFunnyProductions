      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <div className="flex-1">
          ...
          <input
            ...
            onBlur={handleBlur}
            disabled={disabled}
            className="mt-1 w-full rounded border border-gray-300 px-3 py-2 font-mono text-sm uppercase tracking-wider text-black shadow-sm focus:border-amber-400 focus:outline-none"
            placeholder="#000000"
            inputMode="text"
          />
