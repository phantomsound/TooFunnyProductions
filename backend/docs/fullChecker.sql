...
with expected as (
  select * from (values
    ...
    ('settings_draft',  'home_theme_accent',            'text'),
    ('settings_draft',  'home_theme_bg',                'text'),
    ('settings_draft',  'home_header_bg',               'text'),
    ('settings_draft',  'home_footer_bg',               'text'),
    ('settings_draft',  'about_theme_accent',           'text'),
    ('settings_draft',  'about_theme_bg',               'text'),
    ('settings_draft',  'about_header_bg',              'text'),
    ('settings_draft',  'about_footer_bg',              'text'),
    ('settings_draft',  'events_theme_accent',          'text'),
    ('settings_draft',  'events_theme_bg',              'text'),
    ('settings_draft',  'events_header_bg',             'text'),
    ('settings_draft',  'events_footer_bg',             'text'),
    ('settings_draft',  'media_theme_accent',           'text'),
    ('settings_draft',  'media_theme_bg',               'text'),
    ('settings_draft',  'media_header_bg',              'text'),
    ('settings_draft',  'media_footer_bg',              'text'),
    ('settings_draft',  'merch_theme_accent',           'text'),
    ('settings_draft',  'merch_theme_bg',               'text'),
    ('settings_draft',  'merch_header_bg',              'text'),
    ('settings_draft',  'merch_footer_bg',              'text'),
    ('settings_draft',  'contact_theme_accent',         'text'),
    ('settings_draft',  'contact_theme_bg',             'text'),
    ('settings_draft',  'contact_header_bg',            'text'),
    ('settings_draft',  'contact_footer_bg',            'text'),
    ...
    ('settings_draft',  'hero_badge_enabled',           'boolean'),
    ('settings_draft',  'hero_badge_label',             'text'),
    ('settings_draft',  'hero_badge_variant',           'text'),
    ('settings_draft',  'hero_badge_use_theme_color',   'boolean'),
    ('settings_draft',  'hero_badge_color',             'text'),
    ('settings_draft',  'hero_badge_text_color',        'text'),
    ...
    ('settings_draft',  'who_label',                    'text'),
    ('settings_draft',  'who_show_label',               'boolean'),
    ('settings_draft',  'who_label_size',               'text'),
    ('settings_draft',  'who_title_size',               'text'),
    ('settings_draft',  'who_body_size',                'text'),
    ...
    ('settings_public', 'home_theme_accent',            'text'),
    ('settings_public', 'home_theme_bg',                'text'),
    ('settings_public', 'home_header_bg',               'text'),
    ('settings_public', 'home_footer_bg',               'text'),
    ('settings_public', 'about_theme_accent',           'text'),
    ('settings_public', 'about_theme_bg',               'text'),
    ('settings_public', 'about_header_bg',              'text'),
    ('settings_public', 'about_footer_bg',              'text'),
    ('settings_public', 'events_theme_accent',          'text'),
    ('settings_public', 'events_theme_bg',              'text'),
    ('settings_public', 'events_header_bg',             'text'),
    ('settings_public', 'events_footer_bg',             'text'),
    ('settings_public', 'media_theme_accent',           'text'),
    ('settings_public', 'media_theme_bg',               'text'),
    ('settings_public', 'media_header_bg',              'text'),
    ('settings_public', 'media_footer_bg',              'text'),
    ('settings_public', 'merch_theme_accent',           'text'),
    ('settings_public', 'merch_theme_bg',               'text'),
    ('settings_public', 'merch_header_bg',              'text'),
    ('settings_public', 'merch_footer_bg',              'text'),
    ('settings_public', 'contact_theme_accent',         'text'),
    ('settings_public', 'contact_theme_bg',             'text'),
    ('settings_public', 'contact_header_bg',            'text'),
    ('settings_public', 'contact_footer_bg',            'text'),
    ...
    ('settings_public', 'hero_badge_enabled',           'boolean'),
    ('settings_public', 'hero_badge_label',             'text'),
    ('settings_public', 'hero_badge_variant',           'text'),
    ('settings_public', 'hero_badge_use_theme_color',   'boolean'),
    ('settings_public', 'hero_badge_color',             'text'),
    ('settings_public', 'hero_badge_text_color',        'text'),
    ...
    ('settings_public', 'who_label',                    'text'),
    ('settings_public', 'who_show_label',               'boolean'),
    ('settings_public', 'who_label_size',               'text'),
    ('settings_public', 'who_title_size',               'text'),
    ('settings_public', 'who_body_size',                'text'),
